...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/documents?category=staff_forms', icon: '📝', label: 'Staff Forms', roles: ['admin', 'sr_guard', 'pool_tech', 'lifeguard'] },
      { href: '/documents?category=checklists', icon: '☑', label: 'Aquatic Checklists', roles: ['admin', 'sr_guard', 'pool_tech', 'lifeguard'] },
      { href: '/documents?category=senior_lg', icon: '🏅', label: 'Senior Guard', roles: ['admin', 'sr_guard'] },
      { href: '/documents?category=pool_tech', icon: '🔧', label: 'Pool Tech', roles: ['admin', 'sr_guard', 'pool_tech'] },
      { href: '/documents?category=training', icon: '🎓', label: 'Training Videos', roles: ['admin', 'sr_guard', 'pool_tech', 'lifeguard'] },
